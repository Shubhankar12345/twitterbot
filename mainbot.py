...
while True:
    ...
    api.update_profile(name=f'SHUBHANKARRISWADKAR|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : SHUBHANKARRISWADKAR|{follower_count(user)} Followers')
