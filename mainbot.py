...
while True:
    user = api.get_user('shubhankarrisw2')
    api.update_profile(name=f'SHUBHANKAR|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : SHUBHANKAR|{follower_count(user)} Followers')
