...
while True:
    user = api.get_user('0Shubhankar')
    api.update_profile(name=f'SHUBHANKAR RISWADKAR|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : SHUBHANKAR RISWADKAR|{follower_count(user)} Followers')
